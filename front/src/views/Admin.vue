<template>
  <el-container>
    ...
    <el-header>
      <div class="words">
        <span @click="menuClick('adminLayout')" class="title">互联网医院信息系统欢迎您</span>
      </div>
      <div class="words">
